...
export class CalendarService {
    ...
    populateAdjacentViews(component: ICalendarComponent) {
        ...
        //         console.log("component views not exist")

        //         currentViewStartDate = component.range.startTime;
        //         component.view = component.getViewData(currentViewStartDate);
        ...
        //         // console.log("component views : ", component.views)

        //     } else {

        //         console.log("component views exist")
        ...
        // console.log("component view : ", component.view)
