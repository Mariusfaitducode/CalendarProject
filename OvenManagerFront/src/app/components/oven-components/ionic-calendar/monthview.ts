            ...
            <div class="swiper-wrapper">
                ...
                <!-- <div class="swiper-slide">                    
                    <table *ngIf="0===currentViewIndex" class="table table-bordered table-fixed monthview-datetable">
                        ...
                        <tr>
                            <th *ngFor="let dayHeader of views[0].dayHeaders">
                                <small>{{dayHeader}} 0 {{currentViewIndex}}</small>
                            </th>
                        </tr>
                        </thead>
                        <tbody>
                    ...
                    <table *ngIf="0!==currentViewIndex" class="table table-bordered table-fixed monthview-datetable">
                        ...
                        <tr class="text-center">
                            <th *ngFor="let dayHeader of views[0].dayHeaders">
                                <small>{{dayHeader}} 0 test {{currentViewIndex}}</small>
                            </th>
                        </tr>
                        </thead>
                        <tbody>
                ...
                <div class="swiper-slide">
                    <table *ngIf="1===currentViewIndex" class="table table-bordered table-fixed monthview-datetable">
                        ...
                        <tr>
                            <th *ngFor="let dayHeader of views[1].dayHeaders">
                                <small>{{dayHeader}} 1 {{currentViewIndex}}</small>
                            </th>
                        </tr>
                        </thead>
                        <tbody>
                    ...
                    <table *ngIf="1!==currentViewIndex" class="table table-bordered table-fixed monthview-datetable">
                        ...
                        <tr class="text-center">
                            <th *ngFor="let dayHeader of views[1].dayHeaders">
                                <small>{{dayHeader}} 1 test {{currentViewIndex}}</small>
                            </th>
                        </tr>
                        </thead>
                        <tbody>
                ...
                <div class="swiper-slide">
                    <table *ngIf="2===currentViewIndex" class="table table-bordered table-fixed monthview-datetable">
                        ...
                        <tr>
                            <th *ngFor="let dayHeader of views[2].dayHeaders">
                                <small>{{dayHeader}} 2 {{currentViewIndex}}</small>
                            </th>
                        </tr>
                        </thead>
                        <tbody>
                    ...
                    <table *ngIf="2!==currentViewIndex" class="table table-bordered table-fixed monthview-datetable">
                        ...
                        <tr class="text-center">
                            <th *ngFor="let dayHeader of views[2].dayHeaders">
                                <small>{{dayHeader}} 2 test {{currentViewIndex}}</small>
                            </th>
                        </tr>
                        </thead>
                        <tbody>
...
export class MonthViewComponent implements ICalendarComponent, OnInit, OnDestroy, OnChanges, AfterViewInit {
    ...
    constructor(private calendarService: CalendarService, private zone:NgZone, private cdr: ChangeDetectorRef) {
    }  
    ...
    ngOnInit() {
        ...
        // console.log("ngOnInit monthView")
        ...
        this.currentDateChangedFromParentSubscription = this.calendarService.currentDateChangedFromParent$.subscribe(currentDate => {
            // console.log("currentDateChangedFromParentSubscription")
            this.refreshView();
        });

        this.eventSourceChangedSubscription = this.calendarService.eventSourceChanged$.subscribe(() => {

            console.log("eventSourceChangedSubscription")
            this.onDataLoaded();
        });
    ...
    ngAfterViewInit() {
        // this.slider = new Swiper('.monthview-swiper', {loop : true, virtual : false});
        // let me = this;
    ...
    refreshView() {
        ...
        // Adapt calendar month
        this.calendarService.populateAdjacentViews(this);

        this.updateCurrentView(this.range.startTime, this.view);
