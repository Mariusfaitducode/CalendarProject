        ...
        <div class="swiper dayview-swiper">
            <div class="swiper-wrapper slides-container" [dir]="dir">
                ...
                <div class="swiper-slide slide-container">                    
                                ...
                                <tr>
                                    ...
                                    <td class="calendar-cell" *ngIf="0!==currentViewIndex">
                                        <ng-template [ngTemplateOutlet]="dayviewInactiveAllDayEventSectionTemplate"
                                                    [ngTemplateOutletContext]="{allDayEvents:view.allDayEvents}">
                                        </ng-template>
                                    </td>
                                </tr>
                                </tbody>
                    ...
                    <init-position-scroll  class="dayview-normal-event-container"
...
export class DayViewComponent implements ICalendarComponent, OnInit, OnChanges, OnDestroy, AfterViewInit {
    ...
    private getHourColumnLabels(): string[] {
        ...
        for (let hour = 0, length = this.view.rows.length; hour < length; hour += 1) {
            ...
            if (hour === 0 && this.view.rows[hour].time.getHours() !== this.startHour) {
                const time = new Date(this.view.rows[hour].time);
